    ...
    <div id="main-list" v-cloak>
        <v-layout>
            <v-flex xs12 sm6 offset-sm3>
                ...
                <v-alert class="m2-card" color="info" icon="info" outline value="true">Please be aware that your browser may be updated faster than your version of JMP.
            ...
            browsers: [
                {
                    ...
                    content: `1. Add a new bookmark with the following values</br>&emsp;Name = <kbd>JMP</kbd></br>&emsp;Keyword = <kbd>jmp</kbd></br>&emsp;Location = <kbd>${process.env.VUE_APP_BASE_URL}/jmp?query=%s</kbd>`
                },
                {
                    ...
                    content: `1. Open settings (<code>chrome://settings</code>)</br>2. Click <b>\'Manage search engines\'</b></br>3. Add new with the following information</br>&emsp;Search engine = <kbd>JMP</kbd></br>&emsp;Keyword = <kbd>jmp</kbd></br>&emsp;URL = <kbd>${process.env.VUE_APP_BASE_URL}/jmp?query=%s</kbd>`
                },
                {
                    name: 'Safari',

...
dependencies {
	...
	implementation("com.github.djcass44:jmp-security-utils:0.1.RC4")
//	implementation("dev.dcas.jmp.security:core:0.1.1-SNAPSHOT")
//	implementation("dev.dcas.jmp.security:shim:0.1.1-SNAPSHOT")
